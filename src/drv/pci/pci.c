...
static const char *PCI_class_name(uint32_t class_id)
{
  switch (class_id >> 8) {
    ...
    case 0x0206: return "PICMG 2.14 Multi Computing";
    case 0x0608: return "RACEway Bridge";
    case 0x0E00: return "I20 Architecture";
  }
  switch (class_id) {
...
{
  switch (vendor_id) {
    case 0x04B3: return "IBM";
    case 0x8086: return "Intel corporation";
    case 0x1022: return "Intel corporation";
    case 0x80ee: return "InnoTek";
...
static const char *PCI_class_name(uint32_t class_id)
{
  ...
  switch (class_id) {
    ...
    case 0x010200: return "Floppy Disk Controller";
    ...
    case 0x0C0300: return "USB (Universal Host)";
    case 0x0C0310: return "USB (Open Host)";
    case 0x0C0320: return "USB2 (Intel Enhanced Host)";
    case 0x0C0330: return "USB3 XHCI";
  }
  return NULL;
}
